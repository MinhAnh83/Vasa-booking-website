...
namespace VasaHotel_main.Areas.Admin.Controllers
{
    ...
    public class RoomsController : Controller
    {
        ...
        public RoomsController(VasaHotelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("room_id,TyperoomID,Name,Status,Image,Description")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("room_id,TyperoomID,Name,Status,Image,Description")] Room room)
        {
            if (id != room.room_id)
            {
                return NotFound();
