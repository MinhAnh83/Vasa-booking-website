...
namespace VasaHotel_main.Areas.Admin.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(VasaHotelContext context)
        {
            _context = context;
        }
        ...
        {
            var vasaHotelContext = _context.Review.Include(r => r.Room);
        ...
        public async Task<IActionResult> Create([Bind("review_id,Name,Day,Rating,Review_content,RoomID")] Review review)
        {
            ...
            ViewData["RoomID"] = new SelectList(_context.Room, "room_id", "room_id", review.RoomID);
            return View(review);
        }
